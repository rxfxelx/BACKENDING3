import random, urllib.parse, base64, unicodedata, time
                ...
                for term in terms:
                    ...
                    while True:
                        ...
                        try:
                            ...
                            # tenta pular para próxima página em caso de navegação falha
                            idx += 1
                            continue
                        ...
                        if await _is_captcha_or_sorry(page):
                            ...
                            # cooldown curto e continua
                            wait_s = _cooldown_secs(captcha_hits_global)
                            await page.wait_for_timeout(wait_s * 1000)
                            # tenta próximo termo/cidade depois de poucas batidas
                            if captcha_hits_term >= 2:
                                break  # pula este termo
                            # caso contrário, tenta próxima página do mesmo termo
                            idx += 1
                            continue
